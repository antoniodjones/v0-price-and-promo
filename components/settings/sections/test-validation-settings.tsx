...
export default function TestValidationSettings() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-2xl font-bold text-black">Test Validation</h3>
          <p className="text-muted-foreground mt-1">Validate pricing scenarios and rules before deployment</p>
        </div>
