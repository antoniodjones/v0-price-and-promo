-- =====================================================================================
-- Script 89: Link Discount Analytics Code to Stories
-- =====================================================================================
-- Links code files, components, and Git history to Discount Analytics user stories
-- Tracks implementation across 6 stories with retroactive Git commits
-- =====================================================================================

-- Link code files to Discount Analytics stories
...
WHERE us.epic = 'Discount Analytics';
...
SELECT 
  ...
  CASE 
    WHEN unnest(us.related_components) LIKE '%Chart' THEN 'visualization'
    WHEN unnest(us.related_components) LIKE '%Dashboard' THEN 'page'
    WHEN unnest(us.related_components) LIKE '%Analysis' THEN 'feature'
    WHEN unnest(us.related_components) LIKE '%Recommendation%' THEN 'ai'
    ELSE 'component'
  END,
  NOW()
FROM user_stories us
...
-- Create retroactive Git commits for Discount Analytics implementation
...
-- Verification
SELECT 
  'Discount Analytics Code Linking Summary' as summary,
