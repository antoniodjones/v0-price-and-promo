-- Seed Products for GTI Cannabis Dispensary (Version 4 - Final)
-- 45 realistic cannabis products across categories
-- Exact schema match: id, sku, name, brand, category, price, cost, thc_percentage, inventory_count, batch_id, status, created_at, updated_at
