-- Seed Products for GTI Cannabis Dispensary
...
VALUES
  ...
  (gen_random_uuid(), 'VPE-006', 'Purple Punch Disposable', 'Dogwalkers', 'Vapes', 30.00, 15.00, 82.8, 220, 'BTH-2025-021', 'active', NOW(), NOW()),
  (gen_random_uuid(), 'VPE-007', 'Jack Herer Vape Cart 0.5g', 'Rhythm', 'Vapes', 36.00, 18.00, 84.5, 190, 'BTH-2025-022', 'active', NOW(), NOW()),
  (gen_random_uuid(), 'VPE-008', 'Granddaddy Purple Disposable', 'Cookies', 'Vapes', 32.00, 16.00, 83.2, 210, 'BTH-2025-023', 'active', NOW(), NOW()),
  ...
  (gen_random_uuid(), 'VPE-011', 'Pineapple Express Disposable', 'Rhythm', 'Vapes', 31.00, 15.50, 83.9, 215, 'BTH-2025-026', 'active', NOW(), NOW()),
...
VALUES
  ...
  (gen_random_uuid(), 'EDI-003', 'Chocolate Bar 100mg', 'Mindy''s', 'Edibles', 20.00, 10.00, 10.0, 250, 'BTH-2025-030', 'active', NOW(), NOW()),
  (gen_random_uuid(), 'EDI-004', 'Mango Gummies 20pk', 'Incredibles', 'Edibles', 45.00, 22.50, 20.0, 200, 'BTH-2025-031', 'active', NOW(), NOW()),
  (gen_random_uuid(), 'EDI-005', 'Peanut Butter Chocolate Bar 100mg', 'Mindy''s', 'Edibles', 22.00, 11.00, 10.0, 240, 'BTH-2025-032', 'active', NOW(), NOW()),
  ...
  (gen_random_uuid(), 'EDI-007', 'Dark Chocolate Bar 100mg', 'Mindy''s', 'Edibles', 21.00, 10.50, 10.0, 260, 'BTH-2025-034', 'active', NOW(), NOW()),
  (gen_random_uuid(), 'EDI-008', 'Mixed Berry Gummies 10pk', 'Incredibles', 'Edibles', 25.00, 12.50, 10.0, 285, 'BTH-2025-035', 'active', NOW(), NOW()),
  (gen_random_uuid(), 'EDI-009', 'Caramel Chocolate Bar 100mg', 'Mindy''s', 'Edibles', 23.00, 11.50, 10.0, 235, 'BTH-2025-036', 'active', NOW(), NOW()),
